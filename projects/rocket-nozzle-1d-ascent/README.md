...
**Python simulation of ideal rocket-nozzle performance coupled to a simplified 1D vertical ascent model**
...
The original exploratory notebook was consolidated into a clean standalone source script, with baseline data exports retained for inspection.
...
AI tools were used as a coding/debugging copilot during development. I ran the simulations, checked the outputs, and iterated the model parameters and assumptions. Before publication, the uploaded dataset was rechecked against a fresh execution of the model and matched to numerical roundoff.

## Key engineering takeaways

This project demonstrates:

- compressible-flow and ideal-nozzle modelling
- coupling propulsion performance to atmospheric pressure
- ODE modelling of ascent dynamics
- altitude-dependent gravity and aerodynamic drag
- Max-Q extraction from simulated time histories
- Python scientific computing and numerical integration
- engineering interpretation of assumptions, limitations, and outputs
